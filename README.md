...
10. 깃허브에서 풀 리퀘스트를 생성하여 자신의 브랜치를 메인 브랜치에 병합하도록 요청합니다.

위의 단계를 따라 "/path/to/your/local/repository" 디렉토리에서 작업을 진행하시면 됩니다. 이 디렉토리가 로컬 Git 저장소의 루트 디렉토리이므로, 이 디렉토리 내에서 모든 Git 명령어를 실행할 수 있습니다.
